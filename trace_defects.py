...
def track_defect_on_diamond(fileid, src_folder,save_folder,video_folder):
    ...
    for i in range(int(temp_file_count)):
        if os.path.isfile(os.path.join(temp_folder, fileid + '_' + str(i) + '_0.txt')):
            ...
            colors[i, :] = (255, 0, 0)
        elif os.path.isfile(os.path.join(temp_folder, fileid + '_' + str(i) + '_1.txt')):
            is_inclusion[i] = 1
...
def main():
    src_folder = r'../data_output/5_trajectory_1213/inclusion_bbox'
    save_folder = r'../data_output/5_trajectory_1213'
    video_folder = r'../data_output/6_Videos'
